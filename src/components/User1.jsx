...
/* these are the input visibilities */
    ...
    const [inputVisibleTransfer, setinputVisibleTransfer] = useState(false)
...
// disappearing buttons line 75-97 //
    ...
    const handleTransfer = () => {
        setinputVisibleTransfer(!inputVisibleTransfer)
    }
    ...
    return (
        <fieldset className='userinfo'>
            ...
            <button type='button' id='addbtn' onClick={handleTransfer}>Transfer</button>{' '}
...
{inputVisibleTransfer &&(<input
    id="inputAmount"
      ...
      onKeyDown={keydownTransfer}
      className={inputVisibleTransfer ? 'visible' : 'hidden'}
      placeholder="Amount"
    />)}
